...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[2] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			channel.FieldCallerAccessMode:        {Type: field.TypeEnum, Column: channel.FieldCallerAccessMode},
		},
	}
	graph.Nodes[3] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   channelcalleraclmember.Table,
			Columns: channelcalleraclmember.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeInt,
				Column: channelcalleraclmember.FieldID,
			},
		},
		Type: "ChannelCallerACLMember",
		Fields: map[string]*sqlgraph.FieldSpec{
			channelcalleraclmember.FieldCreatedAt: {Type: field.TypeTime, Column: channelcalleraclmember.FieldCreatedAt},
			channelcalleraclmember.FieldUpdatedAt: {Type: field.TypeTime, Column: channelcalleraclmember.FieldUpdatedAt},
			channelcalleraclmember.FieldChannelID: {Type: field.TypeInt, Column: channelcalleraclmember.FieldChannelID},
			channelcalleraclmember.FieldAPIKeyID:  {Type: field.TypeInt, Column: channelcalleraclmember.FieldAPIKeyID},
		},
	}
	graph.Nodes[4] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   channelhealthproberun.Table,
			Columns: channelhealthproberun.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeInt,
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			channelhealthproberun.FieldCreatedAt:    {Type: field.TypeTime, Column: channelhealthproberun.FieldCreatedAt},
			channelhealthproberun.FieldUpdatedAt:    {Type: field.TypeTime, Column: channelhealthproberun.FieldUpdatedAt},
			channelhealthproberun.FieldChannelID:    {Type: field.TypeInt, Column: channelhealthproberun.FieldChannelID},
			channelhealthproberun.FieldModelID:      {Type: field.TypeString, Column: channelhealthproberun.FieldModelID},
			channelhealthproberun.FieldSource:       {Type: field.TypeEnum, Column: channelhealthproberun.FieldSource},
			channelhealthproberun.FieldStatus:       {Type: field.TypeEnum, Column: channelhealthproberun.FieldStatus},
			channelhealthproberun.FieldStream:       {Type: field.TypeBool, Column: channelhealthproberun.FieldStream},
			channelhealthproberun.FieldTtfbMs:       {Type: field.TypeFloat64, Column: channelhealthproberun.FieldTtfbMs},
			channelhealthproberun.FieldTtftMs:       {Type: field.TypeFloat64, Column: channelhealthproberun.FieldTtftMs},
			channelhealthproberun.FieldTotalMs:      {Type: field.TypeFloat64, Column: channelhealthproberun.FieldTotalMs},
			channelhealthproberun.FieldErrorMessage: {Type: field.TypeString, Column: channelhealthproberun.FieldErrorMessage},
			channelhealthproberun.FieldScheduleKey:  {Type: field.TypeString, Column: channelhealthproberun.FieldScheduleKey},
			channelhealthproberun.FieldStartedAt:    {Type: field.TypeTime, Column: channelhealthproberun.FieldStartedAt},
			channelhealthproberun.FieldCompletedAt:  {Type: field.TypeTime, Column: channelhealthproberun.FieldCompletedAt},
		},
	}
...
// WhereHasChannelCallerACLMembers applies a predicate to check if query has an edge channel_caller_acl_members.
func (f *APIKeyFilter) WhereHasChannelCallerACLMembers() {
	f.Where(entql.HasEdge("channel_caller_acl_members"))
}

// WhereHasChannelCallerACLMembersWith applies a predicate to check if query has an edge channel_caller_acl_members with a given conditions (other predicates).
func (f *APIKeyFilter) WhereHasChannelCallerACLMembersWith(preds ...predicate.ChannelCallerACLMember) {
	f.Where(entql.HasEdgeWith("channel_caller_acl_members", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereCallerAccessMode applies the entql string predicate on the caller_access_mode field.
func (f *ChannelFilter) WhereCallerAccessMode(p entql.StringP) {
	f.Where(p.Field(channel.FieldCallerAccessMode))
}
...
// WhereHasHealthProbeRuns applies a predicate to check if query has an edge health_probe_runs.
func (f *ChannelFilter) WhereHasHealthProbeRuns() {
	f.Where(entql.HasEdge("health_probe_runs"))
}

// WhereHasHealthProbeRunsWith applies a predicate to check if query has an edge health_probe_runs with a given conditions (other predicates).
func (f *ChannelFilter) WhereHasHealthProbeRunsWith(preds ...predicate.ChannelHealthProbeRun) {
	f.Where(entql.HasEdgeWith("health_probe_runs", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasCallerACLMembers applies a predicate to check if query has an edge caller_acl_members.
func (f *ChannelFilter) WhereHasCallerACLMembers() {
	f.Where(entql.HasEdge("caller_acl_members"))
}

// WhereHasCallerACLMembersWith applies a predicate to check if query has an edge caller_acl_members with a given conditions (other predicates).
func (f *ChannelFilter) WhereHasCallerACLMembersWith(preds ...predicate.ChannelCallerACLMember) {
	f.Where(entql.HasEdgeWith("caller_acl_members", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// addPredicate implements the predicateAdder interface.
func (_q *ChannelCallerACLMemberQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ChannelCallerACLMemberQuery builder.
func (_q *ChannelCallerACLMemberQuery) Filter() *ChannelCallerACLMemberFilter {
	return &ChannelCallerACLMemberFilter{config: _q.config, predicateAdder: _q}
}

// addPredicate implements the predicateAdder interface.
func (m *ChannelCallerACLMemberMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ChannelCallerACLMemberMutation builder.
func (m *ChannelCallerACLMemberMutation) Filter() *ChannelCallerACLMemberFilter {
	return &ChannelCallerACLMemberFilter{config: m.config, predicateAdder: m}
}

// ChannelCallerACLMemberFilter provides a generic filtering capability at runtime for ChannelCallerACLMemberQuery.
type ChannelCallerACLMemberFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ChannelCallerACLMemberFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql int predicate on the id field.
func (f *ChannelCallerACLMemberFilter) WhereID(p entql.IntP) {
	f.Where(p.Field(channelcalleraclmember.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ChannelCallerACLMemberFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(channelcalleraclmember.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ChannelCallerACLMemberFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(channelcalleraclmember.FieldUpdatedAt))
}

// WhereChannelID applies the entql int predicate on the channel_id field.
func (f *ChannelCallerACLMemberFilter) WhereChannelID(p entql.IntP) {
	f.Where(p.Field(channelcalleraclmember.FieldChannelID))
}

// WhereAPIKeyID applies the entql int predicate on the api_key_id field.
func (f *ChannelCallerACLMemberFilter) WhereAPIKeyID(p entql.IntP) {
	f.Where(p.Field(channelcalleraclmember.FieldAPIKeyID))
}

// WhereHasChannel applies a predicate to check if query has an edge channel.
func (f *ChannelCallerACLMemberFilter) WhereHasChannel() {
...
func (f *ChannelCallerACLMemberFilter) WhereHasChannelWith(preds ...predicate.Channel) {
...
func (f *ChannelCallerACLMemberFilter) WhereHasAPIKey() {
...
func (f *ChannelCallerACLMemberFilter) WhereHasAPIKeyWith(preds ...predicate.APIKey) {
...
// addPredicate implements the predicateAdder interface.
func (_q *ChannelHealthProbeRunQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ChannelHealthProbeRunQuery builder.
func (_q *ChannelHealthProbeRunQuery) Filter() *ChannelHealthProbeRunFilter {
	return &ChannelHealthProbeRunFilter{config: _q.config, predicateAdder: _q}
}

// addPredicate implements the predicateAdder interface.
func (m *ChannelHealthProbeRunMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ChannelHealthProbeRunMutation builder.
func (m *ChannelHealthProbeRunMutation) Filter() *ChannelHealthProbeRunFilter {
	return &ChannelHealthProbeRunFilter{config: m.config, predicateAdder: m}
}

// ChannelHealthProbeRunFilter provides a generic filtering capability at runtime for ChannelHealthProbeRunQuery.
type ChannelHealthProbeRunFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ChannelHealthProbeRunFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql int predicate on the id field.
func (f *ChannelHealthProbeRunFilter) WhereID(p entql.IntP) {
	f.Where(p.Field(channelhealthproberun.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ChannelHealthProbeRunFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(channelhealthproberun.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ChannelHealthProbeRunFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(channelhealthproberun.FieldUpdatedAt))
}

// WhereChannelID applies the entql int predicate on the channel_id field.
func (f *ChannelHealthProbeRunFilter) WhereChannelID(p entql.IntP) {
	f.Where(p.Field(channelhealthproberun.FieldChannelID))
}

// WhereModelID applies the entql string predicate on the model_id field.
func (f *ChannelHealthProbeRunFilter) WhereModelID(p entql.StringP) {
	f.Where(p.Field(channelhealthproberun.FieldModelID))
}

// WhereSource applies the entql string predicate on the source field.
func (f *ChannelHealthProbeRunFilter) WhereSource(p entql.StringP) {
	f.Where(p.Field(channelhealthproberun.FieldSource))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *ChannelHealthProbeRunFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(channelhealthproberun.FieldStatus))
}

// WhereStream applies the entql bool predicate on the stream field.
func (f *ChannelHealthProbeRunFilter) WhereStream(p entql.BoolP) {
	f.Where(p.Field(channelhealthproberun.FieldStream))
}

// WhereTtfbMs applies the entql float64 predicate on the ttfb_ms field.
func (f *ChannelHealthProbeRunFilter) WhereTtfbMs(p entql.Float64P) {
	f.Where(p.Field(channelhealthproberun.FieldTtfbMs))
}

// WhereTtftMs applies the entql float64 predicate on the ttft_ms field.
func (f *ChannelHealthProbeRunFilter) WhereTtftMs(p entql.Float64P) {
	f.Where(p.Field(channelhealthproberun.FieldTtftMs))
}

// WhereTotalMs applies the entql float64 predicate on the total_ms field.
func (f *ChannelHealthProbeRunFilter) WhereTotalMs(p entql.Float64P) {
	f.Where(p.Field(channelhealthproberun.FieldTotalMs))
}

// WhereErrorMessage applies the entql string predicate on the error_message field.
func (f *ChannelHealthProbeRunFilter) WhereErrorMessage(p entql.StringP) {
	f.Where(p.Field(channelhealthproberun.FieldErrorMessage))
}

// WhereScheduleKey applies the entql string predicate on the schedule_key field.
func (f *ChannelHealthProbeRunFilter) WhereScheduleKey(p entql.StringP) {
	f.Where(p.Field(channelhealthproberun.FieldScheduleKey))
}

// WhereStartedAt applies the entql time.Time predicate on the started_at field.
func (f *ChannelHealthProbeRunFilter) WhereStartedAt(p entql.TimeP) {
	f.Where(p.Field(channelhealthproberun.FieldStartedAt))
}

// WhereCompletedAt applies the entql time.Time predicate on the completed_at field.
func (f *ChannelHealthProbeRunFilter) WhereCompletedAt(p entql.TimeP) {
	f.Where(p.Field(channelhealthproberun.FieldCompletedAt))
}

// WhereHasChannel applies a predicate to check if query has an edge channel.
func (f *ChannelHealthProbeRunFilter) WhereHasChannel() {
	f.Where(entql.HasEdge("channel"))
}

// WhereHasChannelWith applies a predicate to check if query has an edge channel with a given conditions (other predicates).
func (f *ChannelHealthProbeRunFilter) WhereHasChannelWith(preds ...predicate.Channel) {
	f.Where(entql.HasEdgeWith("channel", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
